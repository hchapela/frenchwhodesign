...
export default function Home({ designers }) {
  return (
    <div className="container">
      <Head>
        <title>frenchs Who Design | About</title>
      ...
      >
        <p className="f1 extend">
          ...
          <motion.span variants={item}>french designers to</motion.span>{" "}
      ...
      <div className="moreabout">
        <div className="col-left">
          ...
          <p>
            If you know a French designer whose work or voice is valuable to
          ...
          <p>
            We wanted to showcase not only contemporary french design, but
            ...
            reload the website there’s a new featured french designer you can
            learn more about.
          </p>
